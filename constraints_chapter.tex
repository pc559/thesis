...
%    \end{tabular}
    ...
    When we examine the convergence to the sum and product scaling templates,
...
\caption{
    ...
    we can see that sum scaling and the product scaling perform
    ...
    bispctrum deep enough into the squeezed limit, due to their local-type shape.
