...
\section{$\dbi$ sound speed constraint}
    ...
    was run with the same basis\footnote{
        ...
        Future implementations of $\cmbbest$ will include polarisation, but at present it is only
        implemented for temperature data.
    }.
    ...
    maps---$\modal$ uses $\sim300$ maps while $\cmbbest$ uses $140$. Numerical issues
    ...
    \begin{figure}[htbp!]
        ...
        \caption{
            ...
            \textcolor{red}{Double check $68$ v.s.\ $95$ everywhere.}
