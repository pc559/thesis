...
\section{$\dbi$ sound speed constraint}
    ...
    In Appendix B of~\cite{Planck_NG_2013}, the expected scatter of an estimator with an
    imperfect expansion was calculated. The $\modal$ result used an expansion with a correlation of $95\%$.
    ...
    we can conclude that our result functions as a validation of our pipeline.
