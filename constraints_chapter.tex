...
\section{The $\primodal$-$\cmbbest$ pipeline}
    ...
    This means that we do not have a mapping from the scales during inflation and the scales
    measured today. As such, the constraint we obtain on the sound speed during inflation
    ...
    Our result is still a useful validation of our pipeline---specifically, we validate the convergence
