...
\section{Validate this convergence by reproducing Planck constraint using DBI template decomposition.}
    \begin{figure}[htbp!]
        ...
        \caption{
            ...
            scanning across values of $\beta_{IR}$ calculating the corresponding primordial bispectra
            using $\primodal$ and comparing them to the $\planck$ $\cmb$ temperature data using
