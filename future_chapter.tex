...
in the $\planck$ analysis, but the result were sufficiently in agreement that we
...
inflationary scenarios through modal bispectrum results from the $\planck$ satellite~\cite{Planck_NG_2018}.
...
$\cmb$ and \textit{LSS} data from forthcoming surveys will be able to use
...
I will extend the methods I have already developed to the case of multiple active fields during inflation,
