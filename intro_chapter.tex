...
The new methods presented in this thesis will be concerned with one step in this pipeline (that of calculating the predictions
of a given theory) but will be designed with the full pipeline in mind.
...
An important theme of this thesis will be the methods of separability and Modal methods (discussed in Section~\ref{sec:bis_est}),
...
calculations tractable, followed by a further layer of approximations to achieve separability.
...
We explain how to swap the physical integral for a computationally cheaper one which evaluates to approximately the same result, we carefully show that we do not encounter the convergence problems of previous methods, and provide an intuition for the robustness of the method, in Section~\ref{sec:starting}.
