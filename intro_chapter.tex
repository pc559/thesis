...
\subsection{Correlation functions}\label{corr_functions}
    ...
    Expectation value over an ensemble.
    ...
    The quantum mechanical nature of the (inflationary) origin of structure means that the predictions
    ...
    values of measurements applied to draws from the predicted probability distribution.
    ...
    The delta functions come from statistical homogeneity, and the fact that $P(k)$
    ...
    has $9$ degrees of freedom, but $B(k_1,k_2,k_3)$ has only three. This is due to the delta function
    ...
    Evidence suggests that this symmetry is not respected by the probability
