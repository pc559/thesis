...
\textcolor{red}{Remove some of the plots, sort out ordering.}
...
We aim to mature this primary tool for looking out at the universe, so we can use it to look
back in time into its high-temperature youth, and the fundamental physics to be found there.


    General relativity tells us how the expansion of the universe depends
    on its matter and energy content.
    This expansion affects the light that travels through the universe,
