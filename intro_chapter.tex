...
extract the fundamental physics waiting to be found in the universe's youth.
    ...
    Using~\eqref{continuity_equation} and the equation of state ($w$, summarized in table~\ref{lcdm_dep_table})
    ...
    $a(t)$, again summarized in table~\ref{lcdm_dep_table}.
