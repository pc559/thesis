...
\section{Outline of thesis}
    ...
    \begin{enumerate}
        \item Connecting inflation models directly to observations,
            through the bispectrum (say where things will be defined).
        \item Constraining the parameters of inflation models, not phenomenological templates
            ($f_{NL}$ etc---make more explicitly distinct).
...
\newpage
    ...
    \begin{enumerate}
        ...
        \item The CMB calculation: expensive, but need only be done once per primordial basis.
