...
Given the context we have outlined,
    ...
    terms that will be defined in chapter~\ref{chapter:intro_bispectra}.
...
in the sense converges far faster in modes than previous methods would in point samples.
    ...
    This placed a constraint on the sound speed of $\dbi$ inflation, $c_s$.
    ...
    This constraint is the translated into a constraint on
