...
\section{Statistical observables}
    ...
    Since $95\%$ of the time the events will fall within the range $[41,59]$, we call this the
    $95\%$ confidence interval.


    Variance. Ergodicity. How this relates to the sky. The power spectrum and other correlations
    are predicted by inflation. Define correlation functions.
\newpage
