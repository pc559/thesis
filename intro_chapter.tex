...
to a summary of the general cosmological context for the remainder of this chapter.
...
are basis sets, $\cmb$ comparison, as discussed in Chapters~\textcolor{red}{reference}.
