...
\textcolor{red}{Define conformal time here, conformal distance, physical distance.}
    ...
    We will only consider a flat universe, so $dS_3^2=dx^2+dy^2+dz^2$. \textcolor{red}{WHY?}
    ...
    Dark energy appears to act as a vacuum energy, or a cosmological constant which does not
    ...
    and dark energy (described by a cosmological constant~\textcolor{red}{just $\Lambda$, stop mentioning dark energy?})
    respectively.
    ...
    We also have the continuity equation\textcolor{red}{From where? When true for all components?}
    ...
    \textcolor{red}{$\rho=8\pi G$ divided by and so on.}
    ...
    \textcolor{red}{Move plots here, link to scaling arguments.}
    ...
    The $\lcdm$ model of the history of the universe takes this epoch as its starting point.
...
\textcolor{red}{Not evidence for thermal equilibrium.}
...
\caption{
    ...
    \textcolor{red}{Vertical lines. Scatter these plots in text, link tighter.}
}\label{fig:lcdm_a}
\end{figure}
\begin{figure}[!pth]
\centering     %%% not \center
...
\section{Initial conditions for $\lcdm$}
    ...
    \textcolor{red}{Mention reheating somewhere! Efficient, not thermal.}
    ...
    small, despite the fact that there is no reason to believe it should be.
    ...
    \textcolor{red}{Cut mention of flatness?}


    \textcolor{red}{Where did this come from?}
    ...
    \textcolor{red}{Should this be moved later? Have perturbations been mentioned?
    What is scale invariance? Link.}
    ...
    \textcolor{red}{Meaning of sound speed when homogeneous. Do I actually show it successfully inflates?}
...
$x'\equiv\frac{dx}{dN}=H^{-1}\frac{dx}{dt}$.
    \textcolor{red}{Define e-folds. Which $g_{\mu\nu}$ is the above true for?}
...
The expression for the energy density then follows as
    \textcolor{red}{Identification, interpretation as $\rho$.}
...
\textcolor{red}{Why would they be small? Also, $\mpl=1$, probably?}
...
%\subsection{Criteria for successful inflation}
    ...
    \textcolor{red}{What are perturbations?}
...
\textcolor{red}{Move to later chapter?}
\subsection{From probabilities to observations}\label{corr_functions}
    ...
    or the expectation value of a functional $F$ of a field configuration $f(x)$, respectively as
\textcolor{red}{Cut this entirely?? Define $P$?}
    \begin{align}
...
\textcolor{red}{Imposed by inflation? But they are evidence for inflation?}
...
\textcolor{red}{Move separability later.}
...
\textcolor{red}{The odds of this being an extreme fluctuation are\ldots}
...
\textcolor{red}{Make clearer. Link to power spectrum, then bispectrum.}
