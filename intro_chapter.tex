...
extract the fundamental physics waiting to be found in the universe's youth.
    ...
    One question we can ask is how far light will travel in the remainder of the universe.
    ...
    we find that the points that we see in today's $\cmb$ is a comoving distance of $14.2Gpc$ away.
    We also find the asymptotic value of $\tau$ to be $19.2Gpc$, indicating that we will never see the
