...
\subsection{Probability to observations}\label{corr_functions}
    ...
    Our focus will be on the predictions that models of inflation make
...
\textbf{Chapter~\ref{chapter:intro_general}} is a general introduction to cosmology, and
\textbf{chapter~\ref{chapter:intro_bispectra}} is an introduction to the bispectrum as an observable.


\textbf{Chapter~\ref{chapter:decomp}} describes the first line of research mentioned above---the discussion covers the need to
...
\textbf{Chapter~\ref{chapter:constraints}} presents constraints (obtained in collaboration with Wuhyun Sohn)
