...
contributions do not affect our result. This is investigated in Figure~\ref{fig:plot_time_integrand_scan}.
\textcolor{red}{Check! Link to explicit example~\eqref{ieps_integral}.}
