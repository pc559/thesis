...
\subfloat[$\cos(f(k_1+k_2+k_3))S^{DBI}$]{\label{fig:b}\includegraphics[width=.75\columnwidth]{pmax_reduction_plots_1_1000/dbi_cos15.png}}
\caption{
...
\section{Scaling basis}
    ...
    \end{align}
    when $\varepsilon\ln\left(k\right)$ is sufficiently small for $k\in[\kmin,\kmax]$.
    \newpage
