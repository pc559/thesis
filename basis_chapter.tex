...
\section{Resonant basis}
    ...
    \begin{figure}[!pth]
        \centering
        \subfloat[$\Lbasic$]{\label{fig:basis_plot_a}\includegraphics[width=.75\columnwidth]{basis_plot_diagrams/basis_pmax5_plot_P_0}}\\
        \subfloat[$\Linvk$]{\label{fig:basis_plot_b}\includegraphics[width=.75\columnwidth]{basis_plot_diagrams/basis_pmax5_plot_P_1}}\\
        \subfloat[$\Fbasic$]{\label{fig:basis_plot_c}\includegraphics[width=.75\columnwidth]{basis_plot_diagrams/basis_pmax5_plot_F_0}}\\
        \caption{}
    \end{figure}
    \begin{figure}[!pth]
        \ContinuedFloat
        \centering
        \subfloat[$\Finvk$]{\label{fig:basis_plot_d}\includegraphics[width=.75\columnwidth]{basis_plot_diagrams/basis_pmax5_plot_F_1}}\\
        \subfloat[$\scalingbasis$ basis]{\label{fig:basis_plot_e}\includegraphics[width=.75\columnwidth]{basis_plot_diagrams/basis_pmax5_plot_scaling}}\\
        \subfloat[$\resobasis$ basis]{\label{fig:basis_plot_f}\includegraphics[width=.75\columnwidth]{basis_plot_diagrams/basis_pmax5_plot_reso}}\\
        \caption{
