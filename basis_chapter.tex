...
Insight into this can be gained by considering the explicit example on the left hand side of~\eqref{ieps_integral}.
Performing the integral, and then considering the basis expansion of the result, we see that the
