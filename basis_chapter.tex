...
\section{A tradeoff between $\Pmax$ and $\kmax/\kmin$}\label{sec:tradeoff}
    ...
    constraining power on models such as those of the local type is lost. It is shown
    in that paper that $\kmax/\kmin=1000$ is sufficient, and as we have seen in this chapter
