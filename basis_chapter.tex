...
To achieve this, we represent the shape function~\eqref{shapefn} using a set of basis functions as
    \textcolor{red}{Include triple $q$. Define $\Pmax$.}
...
triplet $p,r,s$ and $\tilde{P}$ to stand for the triplet $\tilde{p},\tilde{r},\tilde{s}$.
    \textcolor{red}{Muddled? Define $V$ properly, more clearly.}
...
more stringent.
    \textcolor{red}{If there was a primordial estimator, this would be the fractional sigma error.
    Is it? But it's limited to be less than $\sqrt{2}$?}
...
\end{align}
    ...
    \textcolor{red}{Link to James 2006(?) paper.}
