...
\begin{figure}[!pth]
\centering
\subfloat[temp]{\label{fig:a}\includegraphics[width=.75\columnwidth]{freq_scan_plots/cos_freq_scan.png}}\\
\subfloat[temp]{\label{fig:a}\includegraphics[width=.75\columnwidth]{freq_scan_plots/cos_log_freq_scan.png}}\\
\caption{
    Frequency scans.
...
\begin{figure}[!pth]
\centering
\subfloat[temp]{\label{fig:a}\includegraphics[width=.75\columnwidth]{freq_scan_plots/dbi_cos_freq_scan.png}}\\
\subfloat[temp]{\label{fig:a}\includegraphics[width=.75\columnwidth]{freq_scan_plots/dbi_cos_log_freq_scan.png}}\\
\caption{
    Frequency scans, with DBI.
    }\label{fig:plot_freq_scan_dbi}
\end{figure}
\begin{figure}[!pth]
\centering
\subfloat[temp]{\label{fig:a}\includegraphics[width=.75\columnwidth]{time_integrand_convergence_plots/time_integrand_convergence_dbi.png}}\\
\subfloat[temp]{\label{fig:a}\includegraphics[width=.75\columnwidth]{time_integrand_convergence_plots/time_integrand_convergence_malda_reso_0.02.png}}\\
\caption{
    Time integrand scans.
    }\label{fig:plot_time_integrand}
\end{figure}
