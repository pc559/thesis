...
\section{Step 3: the $\cmb$ bispectrum}
    ...
    \begin{align}
        N_B = \sum_{l_i,m_i}\frac{\mathcal{G}^{l_1l_2l_3}_{m_1m_2m_3}b_{l_1l_2l_3}}{C_{l_1}C_{l_2}C_{l_3}}
    \end{align}
...
see~\cite{astro2020_features, astro2020_png, astro2020_features, Ballardini_2017, Sypsas_2017,
