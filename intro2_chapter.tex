...
Work on forecasting future constraints on features was performed
    ...
    \begin{align}
        C_{l_1m_1,l_2m_2}&\approx C_l\delta_{l_1l_2}\delta{m_1~-m_2},\label{diagonal_covariance}\\
...
features can be applied.
    ...
    with the naive implementation scaling as $\Pmax^6$ and requiring terabytes of RAM for reasonable parameters,
