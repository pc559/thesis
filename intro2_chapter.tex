...
as defined in~\cite{Planck_NG_2013, Planck_NG_2015}.
    ...
    (even when that is not dominant, e.g.~\cite{dbi_in_the_sky}).
\section{Connecting the primordial bispectrum to observables}
    ...
    \section{Calculating the primordial bispectrum from an inflation scenario}\label{sec:inin_example}
