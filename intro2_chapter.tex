...
\begin{align}\label{inin_example_2}
    ...
    \bigg>.
\end{align}
We now perform the contractions. If we contract one of the $\zeta{\mathbf{k_i}}$ with
...
\begin{align}
    \left<\zeta_{\mathbf{k_1}}(t)\zeta_{\mathbf{p}}(t')\right>
    &= u_{k_1}(t)u^*_{p}(t')(2\pi)^3\delta^{(3)}(\mathbf{k_1}+\mathbf{p}).
\end{align}
