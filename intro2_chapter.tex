...
\textcolor{red}{
    ...
    We can convert between gauges using $\zeta=\frac{v}{\sqrt{2\varepsilon}a}$.
...
as defined in~\cite{Planck_NG_2013, Planck_NG_2015}.
    ...
    which we will define in~\eqref{tausdef}.
...
\textcolor{red}{Check the prefactor!! Sign?}
...
sidetracked inflation~\cite{RP_1}.
    ...
    \textcolor{red}{What do they do with the bispectrum they calculate?}
    Also~\cite{RP_1, Fumagalli_2019, Marzouk_D3}.
