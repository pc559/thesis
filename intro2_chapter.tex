...
\section{Perturbations about the background}
    ...
    In the uniform density gauge we have
    \begin{align}
        \delta \phi=0, \qquad h_{ij}=a^2 e^{2\zeta} \delta_{ij}.
    \end{align}
    The action for the perturbations is \textcolor{red}{Make notation consistent!!}
    \begin{align}
        S_{2} = \frac{1}{2}\int d^3x d\tau \left[v'^2-c_s^2\left(\partial v\right)^2-\frac{z''}{z}v^2\right]
    \end{align}
    where $z=\frac{a\sqrt{2\varepsilon}}{c_s}$ and $v=-z\zeta$.
    \newpage
