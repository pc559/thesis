...
\section{Perturbations about the background}
    ...
    The Bunch-Davies vacuum mode functions lead us to
...
\begin{align}\label{inin_example_2}
    ...
    \int d^3x~\left(-2\lambda a^3\dzeta^3(\vecx,t')\right)
    \bigg>\\
    =&\left<-2i \zeta_{\mathbf{k_1}}(t)\zeta_{\mathbf{k_2}}(t)\zeta_{\mathbf{k_3}}(t)
    \int_{-\infty(1+i\varepsilon)}^{t}dt'
    \int d^3x~\left(-2\lambda a^3\dzeta^3(\vecx,t')\right)
    \right>\\
    =&\bigg<-2i \zeta_{\mathbf{k_1}}(t)\zeta_{\mathbf{k_2}}(t)\zeta_{\mathbf{k_3}}(t)
...
\begin{align}\label{inin_computer}
    &B(k_1, k_1, k_3)\nonumber\\
    &=
    \Re\left(-2i u_{k_1}(t)u_{k_2}(t)u_{k_3}(t)
    \int_{-\infty(1+i\varepsilon)}^{t}dt'\bigg(-2\lambda(t') a^3(t')\bigg)
    \udot^*_{k_1}(t')
    \udot^*_{k_2}(t')
    \udot^*_{k_3}(t')
    \right).
