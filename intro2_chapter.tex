...
as defined in~\cite{Planck_NG_2013, Planck_NG_2015}.
    ...
    In~\cite{dbi_in_the_sky} $\fnl$ is defined this way, using~\eqref{local_shape}
    evaluated on the equilateral limit.
    ...
    In~\eqref{px_burrage, transport_main} we see $\fnl$ defined as the reduced bispectrum
    \begin{align}
