...
\section{Inflation}
    \subsection{Perturbations about the background}
    Words
    \newpage
    The sound speed $c_s$.
    \newpage
...
\section{The primordial bispectrum}
    ...
    \newpage
    \subsection{Connecting the primordial bispectrum to observables}
    Connecting to the CMB---transfer functions, etc.
\newpage
    \section{Calculating the primordial bispectrum}
...
allow comparison with the CMB.
    ...
    \newpage
    \section{Discuss DBI, then $P(X, \phi)$.}
    Words
    \newpage
...
though these standard results provide useful validation tests.
    ...
    \subsection{Previous work on in-in separability.}
...
other methods impose some non-trivial cutoff at early times.
    \subsection{Their usage in recent works.}
    Words
...
\newpage
    \section{Simons, Planck, projections}
    Words
    \newpage
