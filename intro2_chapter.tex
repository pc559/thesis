...
\section{Perturbations about the background}
    ...
    We recognise this as the action for a scalar field, oscillating
    with a frequency that changes as the universe expands.
    Expanding the mass, we find
    \begin{align}
        \frac{z''}{z} = 2{\left(aH\right)}^2(1+\frac{\eta}{2}-\varepsilon_s)(1+\frac{\eta-2\epscs-2\varepsilon+2\eta'-4\epscs'}{4})
    \end{align}
    so the evolution of the perturbations is well approximated by $\frac{z''}{z} = 2{\left(aH\right)}^2$
    ...
    We can see that at early times$\ldots$
    \newpage
