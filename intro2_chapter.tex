...
\section{Perturbations about the background}
    ...
    To postpone the choice of gauge, we can use the $ADM$ formalism
    ...
    %\end{align}
    In this way the second order action for the perturbations in this gauge can be found to be~\cite{seery_ng_0506}
...
This can either be found directly
...
\section{Step 3: the $\cmb$ bispectrum}\label{sec:cmb_bis}
    ...
    \subsection{Complexity of bispectrum estimation}\label{sec:bis_est}
