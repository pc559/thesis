...
We will see the computational complexity of this calculation,
...
robust pipelines must be developed to bypass the approximations and
limitations of previous methods and
...
\section{Perturbations about the background}
    ...
    We will quantize $v$, as its Fourier modes
...
\subsubsection{Initial conditions for the perturbations}
    ...
    \textcolor{red}{Make $\zeta$ vs.\ $u_k$ vs.\ $v_k$ consistent throughout!}
...
The dimensionless power spectrum $\primpowerspec$ is
...
the $\dbi$ model described in section~\ref{sec:interactions}.
...
Work on forecasting future constraints on features was performed
    ...
    \end{align}
    Here, the diagonal approximation is insufficient for the linear term, so the
