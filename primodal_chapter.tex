...
we need only compute the first $\Pmax$ of the
coefficients in the expansion~\eqref{mode1Dcoeffs_sum} of the $F^{(i)}(\tau, k)$,
...
\section{Conclusions}
    ...
    can be computed precisely and efficiently in a basis-agnostic context
