...
\begin{figure}[!pth]
\centering
    \subfloat[$\mathcal{E}$ for DBI model.]{\label{fig:a}\includegraphics[width=.75\columnwidth]{time_integrand_convergence_plots/time_integrand_convergence_dbi.png}}\\
    \subfloat[$\mathcal{E}$ for resonant model.]{\label{fig:a}\includegraphics[width=.75\columnwidth]{time_integrand_convergence_plots/time_integrand_convergence_malda_reso_0.02.png}}\\
\caption{
...
in figure~\ref{fig:plot_time_integrand}.
