...
\centering
    ...
    \subfloat[$\mathcal{E}$ for resonant model.]{\label{fig:b}\includegraphics[width=.75\columnwidth]{time_integrand_convergence_plots/time_integrand_convergence_malda_reso_0.02.png}}\\
\caption{
