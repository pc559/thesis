...
\textcolor{red}{TO-DO In chapter~\ref{chapter:primordial_results} we characterise DBI resonance, maybe?
Using my code to look at primordial models independently of trying to connect them to the CMB would be
something I can do by myself, but is definitely less interesting.}


\textcolor{red}{TO-DO In chapter~\ref{chapter:constraints} we present constraints (obtained in collaboration with Wuhyun Sohn)
